...
async function seed() {
  ...
  if (!adminPassword) {
    // Jamais de mot de passe admin par défaut silencieux (compte admin trivialement devinable).
    ...
    .values([
      {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              'Apprendre à accueillir et réguler ses émotions dans les phases difficiles.',
          },
        ],
        extra_text: '',
        image_url: null,
