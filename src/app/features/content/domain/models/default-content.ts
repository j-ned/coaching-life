...
export const DEFAULT_PAGES: Record<PageSlug, PageContent> = {
  'life-coach': {
    ...
    introduction: 'En tant que coach de vie certifiée, je vous accompagne dans vos transitions professionnelles et personnelles. Mon approche est centrée sur l\'écoute active, la bienveillance, et la mise en place d\'actions concrètes pour transformer votre quotidien.',
    ...
    extraText: '',
    imageUrl: 'https://exrvdgdutzwogazpbnhw.supabase.co/storage/v1/object/public/coaching-img/pages/life-coach/1772370686948-life_coach_1772273986071.png',
  ...
  'personal-development': {
    ...
    introduction: 'Le développement personnel est un voyage continu vers l\'épanouissement. Apprenez à mieux vous connaître, à identifier vos forces, vos valeurs profondes, et à construire une vie plus alignée avec vos aspirations.',
    ...
    imageUrl: 'https://exrvdgdutzwogazpbnhw.supabase.co/storage/v1/object/public/coaching-img/pages/personal-development/1772370764966-dev_personnel_1772274008072.png',
  ...
  'equine-coaching': {
    ...
    introduction: 'Le cheval est un miroir puissant, authentique et sans jugement de nos émotions et de notre posture. À travers des exercices spécifiques au sol, découvrez une approche expérientielle unique pour développer votre intelligence émotionnelle et votre ancrage.',
    ...
    extraText: 'Aucune connaissance ou pratique préalable de l\'équitation n\'est requise. Tout le travail s\'effectue au sol, en toute sécurité.',
    imageUrl: 'https://exrvdgdutzwogazpbnhw.supabase.co/storage/v1/object/public/coaching-img/pages/equine-coaching/1772370780962-equine_coaching_1772274022062.png',
  ...
  'neuroatypical-parents': {
    ...
    introduction: 'Accompagner un enfant atypique (TDAH, TSA, DYS, HPI) est un véritable parcours du combattant. Je vous propose un espace d\'écoute sécurisant, bienveillant et dénué de tout jugement.',
    ...
    extraText: '',
    imageUrl: 'https://exrvdgdutzwogazpbnhw.supabase.co/storage/v1/object/public/coaching-img/pages/neuroatypical-parents/1772370793962-neuroatypical_parents_1772274045431.png',
...
export const DEFAULT_HERO: HeroSettings = {
  ...
  subtitle: 'Un accompagnement sur-mesure pour vous aider à franchir un cap, que ce soit en développement personnel, coaching de vie, ou en tant que parent d\'enfant atypique.',
  ctaPrimaryText: 'Prendre rendez-vous',
  ctaPrimaryLink: 'contact',
  ctaSecondaryText: 'Découvrir les services',
  ctaSecondaryLink: 'services',
  imageUrl: 'https://exrvdgdutzwogazpbnhw.supabase.co/storage/v1/object/public/coaching-img/home/hero-1772370735691-home_hero_1772273972612.png',
