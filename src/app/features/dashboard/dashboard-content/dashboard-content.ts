...
const ALL_SLUGS: readonly PageSlug[] = ['life-coach', 'personal-development', 'equine-coaching', 'neuroatypical-parents'];
...
@Component({
  ...
  template: `
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <!-- Home page card -->
      <a routerLink="/dashboard/content/home"
        ...
        <div class="w-12 h-12 rounded-xl bg-brand-100 text-brand-500 flex items-center justify-center mb-4">
      ...
      @for (slug of slugs; track slug) {
        <a [routerLink]="['/dashboard/content', slug]"
           class="group bg-white rounded-2xl shadow-sm border border-slate-100 p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          <div class="w-12 h-12 rounded-xl bg-slate-100 text-slate-500 flex items-center justify-center mb-4">
