  ...
  template: `
      ...
      <form [formGroup]="form" (ngSubmit)="submitContact()" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label for="contact-name" class="block text-sm font-medium text-slate-700 mb-1">Nom complet <span aria-hidden="true">*</span></label>
            <input type="text" id="contact-name" formControlName="name" autocomplete="name" aria-required="true"
          ...
          <div>
            <label for="contact-email" class="block text-sm font-medium text-slate-700 mb-1">Email <span aria-hidden="true">*</span></label>
            <input type="email" id="contact-email" formControlName="email" autocomplete="email" aria-required="true"
              class="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-colors"
        ...
        <div>
          <label for="contact-subject" class="block text-sm font-medium text-slate-700 mb-1">Sujet</label>
        ...
        <div>
          <label for="contact-message" class="block text-sm font-medium text-slate-700 mb-1">Message <span aria-hidden="true">*</span></label>
          <textarea id="contact-message" formControlName="message" rows="4" aria-required="true"
            ...
            [class.border-red-500]="form.controls.message.touched && form.controls.message.invalid"></textarea>
